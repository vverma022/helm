...
This is the critical path for Helm parity.
...
## Why Helm's previous approximation failed
...
## Compatibility requirements for Helm
...
1. Codex/Helm remains the actual frontmost application throughout.
