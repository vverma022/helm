...
export async function loadComposerDrafts(client: HelmClient): Promise<ComposerDrafts> {
...
export async function trashSkills(client: HelmClient, dirs: string[]): Promise<void> {
...
export async function pushWorkspace(client: HelmClient, cwd: string): Promise<void> {
