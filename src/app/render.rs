...
impl Helm {
    ...
    /// [`HelmPane::bind`]) and lets the cached-view geometry checks decide
    ...
    /// [`HelmPane`] delegate for the sidebar island.
    ...
    /// [`HelmPane`] delegate for the transcript island.
    ...
    /// [`HelmPane`] delegate for the right-panel island.
...
impl Helm {
    ...
    fn render_toast(
        ...
        div()
            ...
            // Keep the toast top-centered just beneath Helm's 48px header.
