...
pub use helm_protocol::usage::{PlanUsage, PlanWindow, format_tokens, reset_label};
...
fn grok_billing_over_stdio(child: &mut std::process::Child) -> anyhow::Result<Value> {
    ...
    std::thread::Builder::new()
        .name("helm-grok-usage-probe".into())
        .spawn(move || {
