...
//! reading their private stores, while typed updates let Helm discard private
...
pub fn list_provider_sessions(
    ...
    let request = Client.builder().name("helm-session-catalog").connect_with(
        agent,
