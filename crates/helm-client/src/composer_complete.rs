...
use helm_protocol::model::{ProviderKind, ProviderModelOption, ReportedCommand};
...
/// Whether the composer submitted Helm's global terminal-session picker.
...
/// which Helm bridges to the provider's service-tier control. Checking the
