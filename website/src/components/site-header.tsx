...
/** The bar is invisible over the hero and only materialises once the page
 *  scrolls under it, so the top of the page reads as one surface rather than
 *  a strip sitting on another strip. */
  ...
  return (
    ...
    >
      <div className="mx-auto flex h-16 w-full max-w-6xl items-center justify-between px-6 lg:px-8">
        ...
        >
          <HelmMark className="size-[21px]" />
          <span className="text-[15px] font-semibold tracking-tight">Helm</span>
        </Link>
